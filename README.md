...
## What's new in 2025
- Updated dependency baseline for Python 3.11/3.12, PyTorch 2.3, CUDA 12.1, and the latest FastAPI/Gradio/Transformers releases.
...
1. Install [Python 3.11](https://www.python.org/downloads/windows/) (3.11.9 or newer is recommended; Python 3.12 is also supported with the updated dependencies), checking "Add Python to PATH".
...
```
If your system is very new, install Python 3.12 or 3.11 explicitly before running the launcher:
```bash
# Ubuntu 24.04
