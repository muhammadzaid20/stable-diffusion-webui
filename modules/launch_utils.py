...
{"Alternatively, use a binary release of WebUI: https://github.com/AUTOMATIC1111/stable-diffusion-webui/releases/latest" if is_windows else ""}
...
def prepare_environment():
    ...
    torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.9.0+cu128 torchvision==0.24.0+cu128 --extra-index-url {torch_index_url}")
    if args.use_ipex:
